...
echo "========================================="
echo ""
echo "IMPORTANT: to run docker without 'sudo', apply the new group membership:"
echo "  log out and SSH back in   (or run:  newgrp docker )"
echo "Otherwise you'll see: 'permission denied ... /var/run/docker.sock'."
echo ""
echo "Services are starting. Check status with:"
echo "  docker-compose ps          (or: sudo docker-compose ps)"
echo ""
echo "View logs with:"
